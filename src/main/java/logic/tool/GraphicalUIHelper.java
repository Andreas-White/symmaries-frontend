...
public class GraphicalUIHelper {
	...
	public void runInputGenerator() {
		...
		if (jarApplication) {
			jarApplicationHelper.buildConfigurationForJavaApplicationBeforeRunningInputGenerator(secsumFilePath,exceptionEnabeled,taintCheckingEnabled,sourcesAndSinksFilePath,symmariesPath,commandFilePath,methodSkipParameter);
			jarApplicationHelper.runInputGenerator();
		}
		else if (javaProject) {
			javaApplicationHelper.buildConfigurationForJavaApplicationBeforeRunningInputGenerator(secsumFilePath,exceptionEnabeled,taintCheckingEnabled,sourcesAndSinksFilePath,symmariesPath,commandFilePath,methodSkipParameter);
