...
public class JavaApplicationHelper extends Tool {
	 ...
	 * @throws Exception
	 */
	public boolean processSingleJavaApplication(String appPath, String targetFolder,
			String xmlScrSinkPath, String secsumfilePath, boolean exceptionEnabeled, 
	...
	void buildConfigurationForJavaApplicationBeforeLoadingIntoSoot(String appPath,String targetFolder,
