...
public class Tool {
	...
	public Tool(boolean exConifidentiality, boolean imConifidentiality, boolean integrity,
	...
	public Tool(String inputpath, String outputpath, String inputFolderpath) {
	...
	public void writeSCGSFile(SynthesisConfiguratons configurations2) {
		...
		if(!new File(configurations.SymmariesCommandFile).exists() && !Utils.createFile(configurations.SymmariesCommandFile));
			...
			if(!Utils.writeTextFile(configurations.SymmariesCommandFile, "#! /bin/bash\n" + getScgsCommand()))
